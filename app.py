...
st.sidebar.markdown("""
### 🧠 Tahminler Nasıl Üretiliyor?
- Lig ve takım **gol/sayı ortalamaları**
- **xG (beklenen gol)** ve hücum–savunma dengesi
- **Tempo (pace)** ve maç hızı
- Geçmiş maçlardan türetilmiş **istatistiksel eşikler**
- Rastgelelik değil, **olasılık avantajı** hedeflenir
""")
